package nu.epsilon.rss.ui.components.panel.accordion;
...
public class AccordionPanel extends JPanel implements TimingTarget,
        AccordionListener {
    ...
    private LayoutManager createLayout() {
        final MigLayout layout = new MigLayout(new LC().wrap().fillX());
    ...
    private static BoundSize[] getSize(final String values) {
        final BoundSize size = ConstraintParser.parseBoundSize(values, false,
                false);
